...
namespace GoogleARCore.Examples.AugmentedImage
{
    ...
    /// </remarks>
    public class MuseAugmentedImageExampleController : MonoBehaviour
    {
        /// <summary>
        /// A prefab for visualizing an AugmentedImage.
        /// </summary>
        public MuseAugmentedImageVisualizer AugmentedImageVisualizerPrefab;
        ...
        private Dictionary<int, MuseAugmentedImageVisualizer> m_Visualizers
            = new Dictionary<int, MuseAugmentedImageVisualizer>();
        ...
        public void Update()
        {
            ...
            {
                MuseAugmentedImageVisualizer visualizer = null;
                m_Visualizers.TryGetValue(image.DatabaseIndex, out visualizer);
                if (image.TrackingState == TrackingState.Tracking && visualizer == null)
                {
                    // Create an anchor to ensure that ARCore keeps tracking this augmented image.
                    Anchor anchor = image.CreateAnchor(image.CenterPose);
                    visualizer = (MuseAugmentedImageVisualizer)Instantiate(
