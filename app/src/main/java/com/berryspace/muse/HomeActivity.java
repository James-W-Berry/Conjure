...
public class HomeActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateButton.setOnClickListener(v -> {
            File localImageDatabase = new File(this.getFilesDir(), (String) updateButton.getText());
            StorageReference storageReference = storage.getReference();

            storageReference.child("ImageDatabase/" + updateButton.getText())
                    .getFile(localImageDatabase)
                    .addOnSuccessListener(taskSnapshot -> {
                        Log.d(TAG,
                                "saved Muse image database to local device : " + taskSnapshot.toString());
                    })
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(item -> {
            switch (item.getItemId()) {
                ...
                case R.id.navigation_camera:
                    ...
                    intent.putExtra("imageDatabaseVersion", updateButton.getText());
